...
**Windows users:** You might need to close and reopen the terminal for it to recognize changes done elsewhere in the computer (e.g., newly-installed software, changed to system variables, etc.)
</box>
</div>
