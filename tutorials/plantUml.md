...
| Source                                                                                                                                                                                                                                                                                                                                              | Result                                                                    |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| **Replace** <br><br> <pre>TextUi -> MSLogic : getAppearanceOfCellAt(x, y)<br>MSLogic -> TextUi : getConfig()<br>TextUi --> MSLogic : config<br>MSLogic --> TextUi : cellAppearance</pre> **with** <br><br> <pre>ref over MSLogic, TextUi : get minefield appearance</pre>                                                                           | <puml src="images/plantuml/ParentReferenceFrameDiagram.puml" width=300 /> |
