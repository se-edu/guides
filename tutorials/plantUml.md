...
The sections below explain how to use the `PlantUML` plugin in a project. To install the `PlantUML` plugin, you can refer to these guides for [Intellij IDEA](intellijUsefulPlugins.html), [VS Code](vscUsefulPlugins.html), or use [locally](https://plantuml.com/starting) without an IDE.
