...
1. **Install the `PlantUML integration` plugin in IntelliJ IDEA.**
   ...
   1. Then go to `Settings` \> `Other Settings` \> `PlantUML` or search for PlantUML. Configure the path to the `dot` executable. This executable can be found in the `/bin` directory where you installed GraphViz.<br>
    ![Settings - Other Settings - PlantUML: input the path to your dot executable](assets/plantuml/ConfiguringGraphviz.png)
...
![Editing `DeleteSequenceDiagram.puml`](assets/plantuml/EditingDeleteSequenceDiagram.png)
...
![The UI class diagram without additional formatting](assets/plantuml/RawUiDiagram.png)
...
![Length of arrows and its effects](assets/plantuml/ArrowLength.png)
...
<img src="assets/plantuml/AllDown.png">
...
<img src="assets/plantuml/UpAndDown.png">
...
<img src="assets/plantuml/HiddenArrows.png">
...
<img src="assets/plantuml/ABeforeC.png">
...
<img src="assets/plantuml/CBeforeA.png">
...
<img src="assets/plantuml/PackagesAndConsistency.png">
</td>
</tr>
</tbody>
</table>
