...
* **Verify installation** {{ step_numbers }}
  * Ensure you have followed the section [Installing Codex](#installing-codex) above.
* **Open the Codex app**
  * You should see the sign-in screen below.<br>
    <pic src="images/codex/codexSignIn.png" width="600" />
* **Sign in to Codex**
  * `Sign in with ChatGPT` if you are using a school-provided or subscription-based plan.
  * `Sign in with another way` only if you are using an API key.
...
* **Open the project picker**
  ...
  * Select the folder that contains your project.
    <box type="tip" seamless>
      For a Git project like AB3, it is important to select the repository root and not the inner folders like src.
    </box>
...
* **Use Codex for small, reviewable tasks**
  ...
  * In the review panel, check the file name and the red/green lines to understand exactly what Codex changed.
