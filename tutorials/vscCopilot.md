...
### Basic Code Completion
  ...
  * To disable automatic code completion, look for the Copilot icon in the bottom right of vscode:<br>
  ...
  Uncheck the necessary boxes (`All files` disables code completion for all files, while the checkbox below it disables code completion for the currently open file type.) If you have access to Copilot Pro, you can also monitor your Copilot Premium Requests usage here.<br>
