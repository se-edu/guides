...
* `INDEX` refers to the list position of the person you want to add a remark to.
* `REMARK` is the note you wish to attach to their entry.

For example, `remark 2 r/Likes baseball` adds the remark “Likes baseball” to the current person at index 2 of the observable list.
